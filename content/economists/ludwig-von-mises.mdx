...
school: austrian
era: keynesian
knownFor: "The economic calculation problem - why central planners can't do the math without market prices"
summary: |
  Ludwig von Mises was born in 1881 in Lemberg, in the Austro-Hungarian Empire, and made his career in Vienna as a leader of the Austrian school of economics. A Jewish classical liberal, he fled fascist Europe for New York in 1940, taught at NYU until 1969, and died in 1973.

  His famous 1920 argument was that a socialist economy cannot plan rationally, because real prices only come from people trading things they own. Abolish private ownership and the numbers planners need simply never form, leaving them groping in the dark. He also warned that credit booms engineered by cheap money end in busts.
portrait:
  src: /portraits/ludwig-von-mises.jpg
  source: https://commons.wikimedia.org/wiki/File:Ludwig_von_Mises.jpg
  license: CC BY-SA 3.0
influencedBy: [richard-cantillon, carl-menger, jean-baptiste-say]
...
secondarySources:
  ...
  - { title: "Ludwig von Mises - biography", author: "Mises Institute", url: "https://mises.org/profile/ludwig-von-mises" }
videos:
  - { title: "Who Was Ludwig von Mises?", channel: "American Institute for Economic Research (AIER)", url: "https://www.youtube.com/watch?v=GWlytrN0Kh8" }
tryIt: price-signals
flagship: true
...
Before the calculation debate, Mises was a money man. *The Theory of Money and Credit* (1912) knit money - until then treated separately - into the <G term="marginal-utility">marginal utility</G> framework of mainstream value theory. Its practical core: when banks expand credit beyond real savings, they push interest rates artificially low and set off a boom of investments that can't all be completed - the seed of the Austrian <G term="business-cycle">business cycle</G> theory Hayek later elaborated, and a warning issued well before 1929. Mises watched Austria's post-war hyperinflation confirm his darkest lectures about printing money, and he drew a lifelong conclusion: <G term="inflation">inflation</G> is not weather; it's policy. Governments will always be tempted to fund themselves with cheap credit, so money must be anchored - for Mises, ideally by gold - beyond the reach of political convenience.
