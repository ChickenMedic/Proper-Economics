...
summary: |
  Karl Marx was born in 1818 in Trier, in the Prussian Rhineland, and spent most of his life exiled in London, researching in the British Museum while his friend Friedrich Engels paid the bills. Co-author of the Communist Manifesto and author of Capital, he is, measured by earthly consequences, arguably the most influential economist ever.

  He argued that history moves by struggle between classes over who does the work and who keeps the surplus. Under capitalism, workers create more value in a day than their wages cover, and the unpaid remainder becomes the owner's profit. The system's recurring crises, he predicted, would eventually hand power to the working class.
portrait:
  src: /portraits/karl-marx.jpg
  source: https://commons.wikimedia.org/wiki/File:Karl_Marx_001.jpg
  license: Public domain
influencedBy: [adam-smith, william-petty, john-locke, francois-quesnay, david-ricardo, friedrich-engels, robert-owen, thomas-malthus]
influenced: [friedrich-engels, joseph-schumpeter, thomas-piketty]
arguedAgainst: []
works:
...
videos:
  - { title: "POLITICAL THEORY - Karl Marx", channel: "The School of Life", url: "https://www.youtube.com/watch?v=fSQgCy_iIcc" }
tryIt: price-signals
flagship: true
